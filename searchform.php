...
if ( ! class_exists( 'WooCommerce' ) || is_home() || is_singular( 'post' ) || is_category() || is_tag() || is_author() ) {
	$search_target = 'post';
}
$placeholder = ( 'post' === $search_target )
	? __( 'جستجو در مقالات...', 'almas-land' )
	: __( 'جستجو در محصولات...', 'almas-land' );
?>
